...
new #[Layout('layouts.guest')] class extends Component {
    ...
    public function login(): void
    {
        ...
        if (tenant()) {
            ...
            // Only Super Admin users should exist in central context
...
<div>
    ...
    <form wire:submit="login" class="space-y-5">
        ...
        <div>
            <div class="flex items-center justify-between mb-1.5">
                ...
                @if (tenant() ? Route::has('tenant.password.request') : Route::has('password.request'))
                    <a class="text-xs font-semibold text-indigo-600 hover:text-indigo-500 transition-colors"
        ...
        <div class="text-center text-sm text-slate-500 mt-6">
            Belum punya akun?
            <a href="{{ tenant() ? route('tenant.register') : route('register') }}" wire:navigate
                class="font-semibold text-indigo-600 hover:text-indigo-500 transition-colors">Daftar sekarang</a>
        </div>
    </form>
</div>
