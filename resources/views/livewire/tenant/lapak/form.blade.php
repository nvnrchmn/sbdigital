    ...
    <div class="p-6 overflow-y-auto">
        <form wire:submit="save" class="space-y-5">
            <div>
                ...
                <x-text-input wire:model="nama_produk" id="nama_produk" type="text" placeholder="Misal: Kue Nastar Kering, Jasa Servis AC" required />
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <x-text-input wire:model="harga" id="harga" type="number" min="0" placeholder="Misal: 50000" required />
            ...
            <div>
                ...
                <textarea wire:model="deskripsi" id="deskripsi" rows="3" class="flex w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm placeholder:text-slate-400 focus:outline-none focus:border-brand-indigo-500 focus:ring-4 focus:ring-brand-indigo-500/20 disabled:cursor-not-allowed disabled:opacity-50 transition-shadow" placeholder="Jelaskan kondisi barang atau rincian jasa yang ditawarkan..."></textarea>
            ...
            <div>
                ...
                <div wire:loading wire:target="foto" class="text-xs text-brand-indigo-600 mt-2 font-medium flex items-center gap-1.5">
