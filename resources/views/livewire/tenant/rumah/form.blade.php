    ...
    <form wire:submit="save">
        <div class="space-y-5">
            <div>
                ...
                <x-text-input id="nomor_blok" wire:model="nomor_blok" type="text" placeholder="Contoh: Blok A1 No. 05" />
            ...
            <div>
                ...
                <textarea id="keterangan" wire:model="keterangan" rows="3" class="flex w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm placeholder:text-slate-400 focus:outline-none focus:border-brand-indigo-500 focus:ring-4 focus:ring-brand-indigo-500/20 disabled:cursor-not-allowed disabled:opacity-50 transition-shadow" placeholder="Keterangan tambahan (mis. disewakan, kosong, dll)"></textarea>
