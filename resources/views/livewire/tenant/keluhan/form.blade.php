    ...
    <div class="p-6 overflow-y-auto">
        <form wire:submit="save" class="space-y-5">
            <div>
                ...
                <x-text-input wire:model="judul" id="judul" type="text" placeholder="Cth: Lampu Taman Utama Mati"
                    required />
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    <label for="lokasi" class="block text-sm font-semibold text-slate-700 mb-1">Lokasi Kejadian <span
            ...
            <div>
                ...
                <textarea wire:model="deskripsi" id="deskripsi" rows="4"
                    ...
                    placeholder="Jelaskan secara rinci masalah yang terjadi..." required></textarea>
            ...
            <div>
                ...
                @if ($foto)
                    <div class="mb-3 relative rounded-xl overflow-hidden border border-slate-200">
                        ...
                        <button type="button" wire:click="$set('foto', null)"
                            class="absolute top-2 right-2 bg-rose-500 text-white rounded-full p-1 shadow-md hover:bg-rose-600">
                ...
                <div class="flex items-center justify-center w-full">
                    <label for="dropzone-file"
                        class="flex flex-col items-center justify-center w-full h-24 border-2 border-slate-300 border-dashed rounded-xl cursor-pointer bg-slate-50 hover:bg-slate-100 transition-colors">
                        <div class="flex flex-col items-center justify-center pt-5 pb-6">
                            <svg class="w-6 h-6 mb-2 text-slate-400" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="2"
                                    d="M13 13h3a3 3 0 0 0 0-6h-.025A5.56 5.56 0 0 0 16 6.5 5.5 5.5 0 0 0 5.207 5.021C5.137 5.017 5.071 5 5 5a4 4 0 0 0 0 8h2.167M10 15V6m0 0L8 8m2-2 2 2" />
                            </svg>
                            <p class="mb-1 text-xs text-slate-500"><span class="font-semibold">Klik untuk unggah</span>
                                foto dari perangkat</p>
                        </div>
                        <input id="dropzone-file" type="file" wire:model="foto" class="hidden" accept="image/*" />
                    </label>
                </div>
                <div wire:loading wire:target="foto" class="text-xs text-brand-indigo-600 mt-2 font-medium">Mengunggah
                    foto...</div>
