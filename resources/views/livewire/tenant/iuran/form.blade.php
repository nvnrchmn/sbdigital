    ...
    <form wire:submit="save">
        <div class="space-y-5">
            <div>
                ...
                <div class="relative">
                    <select id="id_rumah" wire:model="id_rumah" class="block w-full px-3 py-2 border border-slate-300 rounded-lg bg-white focus:ring-4 focus:ring-brand-indigo-500/20 focus:border-brand-indigo-500 transition-all duration-200 sm:text-sm appearance-none">
            ...
            <div class="grid grid-cols-2 gap-5">
                <div>
                    ...
                    <div class="relative">
                        <select id="bulan" wire:model="bulan" class="block w-full px-3 py-2 border border-slate-300 rounded-lg bg-white focus:ring-4 focus:ring-brand-indigo-500/20 focus:border-brand-indigo-500 transition-all duration-200 sm:text-sm appearance-none">
                            @for($i = 1; $i <= 12; $i++)
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input id="nominal" wire:model="nominal" type="number" class="block w-full pl-12 pr-4 py-2 border border-slate-300 rounded-lg bg-white focus:ring-4 focus:ring-brand-indigo-500/20 focus:border-brand-indigo-500 transition-all duration-200 sm:text-sm" placeholder="50000" />
                </div>
            ...
            <div>
                ...
                <div class="relative">
                    <select id="status" wire:model="status" class="block w-full px-3 py-2 border border-slate-300 rounded-lg bg-white focus:ring-4 focus:ring-brand-indigo-500/20 focus:border-brand-indigo-500 transition-all duration-200 sm:text-sm appearance-none">
