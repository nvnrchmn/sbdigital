    ...
    <form wire:submit="save">
        <div class="space-y-5">
            <div>
                ...
                <x-text-input id="judul" wire:model="judul" type="text" placeholder="Contoh: Lampu jalan mati di Blok A" />
