            ...
            <div class="border-t border-slate-100 pt-5 mt-5">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex gap-2 items-start" wire:key="opsi-{{ $index }}">
                        ...
                        @if(count($opsi) > 2)
                        <button type="button" wire:click="removeOpsi({{ $index }})" class="p-2.5 text-slate-400 hover:text-rose-600 hover:bg-rose-50 rounded-xl transition-colors border border-transparent hover:border-rose-200" title="Hapus opsi ini">
