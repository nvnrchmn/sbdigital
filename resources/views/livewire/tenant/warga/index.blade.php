                    ...
                    <tr class="hover:bg-slate-50/50 transition-colors duration-200 group">
                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="flex justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                                @can('edit warga')
                                <button wire:click="$dispatch('openModal', { component: 'tenant.warga.form', arguments: { warga: {{ $warga->id }} } })" class="inline-flex items-center justify-center h-8 w-8 rounded-lg text-slate-400 hover:text-indigo-600 hover:bg-indigo-50 transition-colors">
