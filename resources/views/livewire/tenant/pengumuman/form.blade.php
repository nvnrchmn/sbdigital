<div class="p-8">
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            <h2 class="text-xl font-display font-bold text-slate-900">
                {{ $pengumumanId ? 'Edit Pengumuman' : 'Buat Pengumuman Baru' }}</h2>
    ...
    <form wire:submit="save">
        <div class="space-y-5">
            <div>
                <label for="judul" class="block text-sm font-medium text-slate-700 mb-1.5">Judul Pengumuman <span
            ...
            <div>
                <label for="isi" class="block text-sm font-medium text-slate-700 mb-1.5">Isi Pengumuman <span
                        class="text-red-500">*</span></label>
                <textarea id="isi" wire:model="isi" rows="6"
                    ...
                    placeholder="Tuliskan detail informasi yang ingin disampaikan..."></textarea>
                <x-input-error :messages="$errors->get('isi')" class="mt-2" />
            </div>

            <div class="flex items-center mt-2">
                <input id="prioritas" wire:model="prioritas" type="checkbox"
                    class="h-4 w-4 text-brand-indigo-600 focus:ring-brand-indigo-500 border-slate-300 rounded" />
